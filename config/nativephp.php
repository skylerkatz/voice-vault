...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.voice-vault.app'),
     ...
     * nativephp://some/path
     */
    'deeplink_scheme' => env('NATIVEPHP_DEEPLINK_SCHEME', 'voicevault'),

    /**
     * The author of your application.
     */
    'author' => env('NATIVEPHP_APP_AUTHOR', 'skylerkatz@hey.com'),
     ...
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'An application to transcribe your thoughts.'),

    /**
     * The Website of your application.
     */
    'website' => env('NATIVEPHP_APP_WEBSITE', 'https://voice-vault.test'),
