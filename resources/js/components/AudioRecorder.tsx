...
export default function AudioRecorder({
                                          vault_id,
                                          selected_device_id: prop_selected_device_id,
                                          onRecordingComplete,
                                          onRecordingStart,
                                          onRecordingStop
                                      }: AudioRecorderProps) {
    ...
    const [selected_device_id, set_selected_device_id] = useState<string>(() => {
        return prop_selected_device_id || localStorage.getItem('voice-vault-microphone-id') || 'default';
    });
    ...
    useEffect(() => {
        if (prop_selected_device_id && prop_selected_device_id !== selected_device_id) {
            set_selected_device_id(prop_selected_device_id);
            handle_device_change(prop_selected_device_id);
        }
    }, [prop_selected_device_id]);
